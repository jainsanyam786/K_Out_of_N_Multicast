...
## This class takes care of all routing related information 
class Routing:
    
    def __init__(self):{}

    #Apply dijkstra algorithm on graph for given source and destination    
    def dijkstra(self,graph, src, dest, visited=[], distances={}, predecessors={}):
     ...
     #User input method to create graph with reference to topology and create routing tables for same      
    ...
    #method to create multicast table based on specification logic
    ...
    #method to find best router based on destination
    ...
    #method to get next hop for given source and destination based on routing table
